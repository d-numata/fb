...
#      config.asset_host = 'https://s3-ap-northeast-1.amazonaws.com/本番環境用のバケット名'
      config.fog_directory = 'numata-production'
      config.asset_host = 'https://s3-ap-northeast-1.amazonaws.com/numata-production'
    when 'development'
#      config.fog_directory = '開発環境用のバケット名'
#      config.asset_host = 'https://s3-ap-northeast-1.amazonaws.com/開発環境用のバケット名'
      config.fog_directory = 'numata-development'
      config.asset_host = 'https://s3-ap-northeast-1.amazonaws.com/numata-development'
#    when 'test'
